...
terraform -chdir=terraform/box apply \
  ...
  -var owner=psecor@launchdarkly.com \
  -var agent_bearer_token="$TOKEN" \
  -var git_user_email=psecor@launchdarkly.com \
  -var git_user_name="Peter Secor"
```
...
```hcl
box_name           = "ami-test-1"
owner              = "psecor@launchdarkly.com"
agent_bearer_token = "tmag_..."
git_user_email     = "psecor@launchdarkly.com"
git_user_name      = "Peter Secor"
```
