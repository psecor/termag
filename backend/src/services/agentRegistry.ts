 ...
 *
 *   userAgents     — keyed by userId. Holds legacy per-user agents
 *                    (Mac via launchd, Linux host via systemd-user).
 *                    One per user; new connect kicks
...
/**
 * Send a request to a user's legacy agent.
 */
